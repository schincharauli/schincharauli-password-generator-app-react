...
function App() {
  ...
  useEffect(() => {
    ...
    }, 3000); // hide the element after 3 seconds
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="generator-password">
           <h3 className="fieldText"> {password}
            </h3>
              <p className="copied-comment">
              {showElement && <p>COPIED</p>}</p>
          ...
          <div className="output-container">
            ...
            <button onClick={handleGeneratePassword} className="generator-btn">
              ...
              Generate 
            <svg className="arrow-icon" width="12" height="12" xmlns="http://www.w3.org/2000/svg"><path fill="#24232C" d="m5.106 12 6-6-6-6-1.265 1.265 3.841 3.84H.001v1.79h7.681l-3.841 3.84z"/></svg>
            </button>
